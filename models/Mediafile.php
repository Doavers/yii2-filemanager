...
namespace doavers\filemanager\models;
...
use doavers\filemanager\models\Owners;
...
class Mediafile extends ActiveRecord
{
    ...
    {
        return $this->hasMany(Owners::className(), ['mediafile_id' => 'mfile_id']);
    }
    ...
    public function addOwner($owner_id, $owner, $owner_attribute)
    {
        ...
        $mediafiles->mediafile_id = $this->mfile_id;
    ...
    public static function findByUrl($url)
    {
        ...
        return self::findOne(['like', 'url', $url]);
    }
