<?php
namespace doavers\filemanager\widgets;

use Yii;
use yii\helpers\Html;
use yii\widgets\InputWidget;
use doavers\filemanager\assets\FileInputAsset;
use yii\helpers\Url;
 ...
 * More samples of usage see on github: https://github.com/doavers/yii2-filemanager
 *
 * @package doavers\filemanager\widgets
...
class FileInput extends InputWidget
{
    ...
    public function run()
    {
        ...
        $modal = $this->renderFile('@vendor/doavers/yii2-filemanager/views/file/modal.php', [
