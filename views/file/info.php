...
use doavers\filemanager\assets\FilemanagerAsset;
use doavers\filemanager\Module;

/* @var $this yii\web\View */
/* @var $model doavers\filemanager\models\Mediafile */
...
<ul class="detail">
    ...
    <li><?= Html::a(Module::t('main', 'Delete'), ['file/delete/', 'id' => $model->mfile_id],
            [
                'class' => 'text-danger',
                'data-confirm' => Yii::t('yii', 'Are you sure you want to delete this item?'),
                'data-id' => $model->mfile_id,
                'role' => 'delete',
            ]
        ) ?></li>
</ul>
...
<?php $form = ActiveForm::begin([
    'action' => ['file/update', 'id' => $model->mfile_id],
    ...
    <?= Html::hiddenInput('id', $model->mfile_id) ?>
