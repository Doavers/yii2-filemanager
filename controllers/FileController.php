...
namespace doavers\filemanager\controllers;
...
use doavers\filemanager\models\Mediafile;
...
class FileController extends Controller
{
    ...
    {
        $this->layout = '@vendor/doavers/yii2-filemanager/views/layouts/main';
        $model = new Mediafile();
    ...
    public function actionUpload()
    {
        ...
        $response['files'][] = [
            ...
            'deleteUrl'     => Url::to(['file/delete', 'id' => $model->mfile_id]),
            'deleteType'    => 'POST',
        ];
